  ...
  return (
    <div className="main bg-[#142434] h-screen w-full fixed">
      ...
      <form onSubmit={handleSubmit}className="grid grid-cols-1 gap-2 w-full max-w-xl mx-auto p-4 bg-[#343c4c] mt-20 rounded-md text-white">
        <h2 className="text-center font-serif text-xl mt-5">LogIn Form</h2>
        ...
        <div className="Password pb-3 pt-5 text-center">
          <label>
            ...
            <input type="password" name="password" onChange={handleChange} className='p-3 rounded-md w-2/3 border-2 border-gray-300 border-opacity-50 
            outline-none peer bg-inherit dark:text-white text-black' />
        ...
        <button type="submit" className="mt-7 bg-[#020304] py-3 mx-[87px] rounded-md">Login</button>
